...
# Image URL of Hong Kong Disneyland
hkd_image_url = "https://raw.githubusercontent.com/zorocubing/Map-of-The-Pearl/main/hkdisney.png"

# Hong Kong Disneyland Pop-Up content
hkd_popup_content = f"""
<div style='width: 250px; text-align: center;'>
    <h4 style='font-family: Arial; color: black; margin-bottom: 10px;'>
    ...
    <img src="{hkd_image_url}" width="200px" style='border-radius: 10px;'><br>
    <p style='font-family: Arial; font-size: 12px; color: gray;'>
        A magical theme park featuring Disney characters on Lantau Island
    </p>
</div>
"""

# Hong Kong Disneyland marker
folium.Marker([22.3123, 114.0448], popup=hkd_popup_content, icon=folium.CustomIcon("https://raw.githubusercontent.com/zorocubing/Map-of-The-Pearl/main/pinkloca.png", icon_size=(30, 30)), tooltip=tooltip).add_to(fg)


# Image URL of Ocean Park
op_image_url = "https://raw.githubusercontent.com/zorocubing/Map-of-The-Pearl/main/oceanpark.png"

# Ocean Park Pop-Up content
hkd_popup_content = f"""
<div style='width: 250px; text-align: center;'>
    <h4 style='font-family: Arial; color: black; margin-bottom: 10px;'>
        Ocean Park
    ...
    <img src="{op_image_url}" width="200px" style='border-radius: 10px;'><br>
    <p style='font-family: Arial; font-size: 12px; color: gray;'>
        A thrilling theme park with marine life and roller coasters on Hong Kong Island
    </p>
</div>
"""
...
map_hk.save("index.html")
webbrowser.open("index.html")


print("Map has been generated! Open index.html to view it")